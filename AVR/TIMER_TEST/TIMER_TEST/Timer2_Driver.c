...
/***********************************************************************************************************/
 static void (*prv_CallBack_ptr)(void) = NULL;              //pointer used to hold address of a function
// extern u8 seconds;
// extern u8 minutes;
// extern u8 hours;
/***********************************************************************************************************
