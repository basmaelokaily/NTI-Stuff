...
void start_synch_2(u8 presc);              /*only used with init_synch (for timer with polling) */

void Delay_ms_sync_2(u32 time);            /*this func called in the main.c...only used with init_synch (for timer with polling) */
